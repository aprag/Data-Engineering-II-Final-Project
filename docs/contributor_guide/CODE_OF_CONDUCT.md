# Code of conduct for `data-engineering-ii-final-project`

Contributors to this repository hosted by `aprag` are expected to follow the
...
- "Project", we mean this `data-engineering-ii-final-project` GitHub repository;
- "Maintainer", we mean the `aprag` organisation owners; and
- "Leadership", we mean both `aprag` organisation owners, line managers, and other
  leadership within the Data_Eng.
...
[apra1013@gmail.com][email-address]. All complaints will be
...
[email-address]: mailto:apra1013@gmail.com
